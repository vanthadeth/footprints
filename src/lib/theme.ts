 ...
 * actual status bar there (the in-page toolbar can still update, which is
 * why this was easy to miss testing in a desktop browser). Removing the
 * old tag and inserting a fresh one forces every browser to notice.
 */
